...
joke_explainer_mode = false;
//(get_player_color(player) == 14)  || (get_player_hud_color(player) == 0x808080);
...
if (joke_explainer_mode)
{
    ...
    //jokex_spr_crouch = 
    jokex_spr_walkturn = sprite_get("walkturn_bot");
    //jokex_spr_dashstart = 
    //jokex_spr_dashstop = 
    //jokex_spr_dashturn = 
    //Air sprites
...
vfx_dspecial_shine_spr = sprite_get("dspecial_shine"); //no relation to Sunshine
vfx_dspecial_shockwave_spr = sprite_get("vfx_shine");
