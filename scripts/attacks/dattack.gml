...
set_hitbox_value(AT_DATTACK, 9, HG_LIFETIME, 8);
set_hitbox_value(AT_DATTACK, 9, HG_WIDTH, 70);
set_hitbox_value(AT_DATTACK, 9, HG_HEIGHT, 70);
set_hitbox_value(AT_DATTACK, 9, HG_PRIORITY, 5);
set_hitbox_value(AT_DATTACK, 9, HG_DAMAGE, 10);
set_hitbox_value(AT_DATTACK, 9, HG_ANGLE, 55);
set_hitbox_value(AT_DATTACK, 9, HG_ANGLE_FLIPPER, 3);
set_hitbox_value(AT_DATTACK, 9, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_DATTACK, 9, HG_KNOCKBACK_SCALING, 0.8);
set_hitbox_value(AT_DATTACK, 9, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_DATTACK, 9, HG_HITPAUSE_SCALING, .5);
set_hitbox_value(AT_DATTACK, 9, HG_HIT_SFX, sound_get("sfx_noz_ice_medium"));
set_hitbox_value(AT_DATTACK, 9, HG_VISUAL_EFFECT, 1);

set_hitbox_value(AT_DATTACK, 9, HG_PROJECTILE_SPRITE, sprite_get("vfx_ice_big"));
set_hitbox_value(AT_DATTACK, 9, HG_PROJECTILE_ANIM_SPEED, 0.7);
set_hitbox_value(AT_DATTACK, 9, HG_PROJECTILE_MASK, -1);
...
set_hitbox_value(AT_DATTACK, 9, HG_PROJECTILE_DOES_NOT_REFLECT, 1);
set_hitbox_value(AT_DATTACK, 9, HG_PROJECTILE_IS_TRANSCENDENT, 1);
set_hitbox_value(AT_DATTACK, 9, HG_MUNO_OBJECT_LAUNCH_ANGLE, -2);
