...
set_attack_value(AT_BAIR, AG_STRONG_CHARGE_WINDOW, 153); //enables strong_charge boost
...
set_hitbox_value(AT_BAIR, 3, HG_HIT_LOCKOUT, 8);
...
set_hitbox_value(AT_BAIR, 3, HG_PROJECTILE_HSPEED, -1.25);
set_hitbox_value(AT_BAIR, 3, HG_PROJECTILE_AIR_FRICTION, 0.3);
set_hitbox_value(AT_BAIR, 3, HG_PROJECTILE_GROUND_FRICTION, 0.3);
...
set_hitbox_value(AT_BAIR, 9, HG_ANGLE_FLIPPER, 3);
