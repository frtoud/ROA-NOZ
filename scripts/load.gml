...
sprite_change_offset("jex_ftilt", 18, 27, true);
...
sprite_change_offset("thunder_cloud", 40, 46);
sprite_change_offset("thunder_cloud_hurt", 26, 38);
sprite_change_offset("thunder_cloud_burst", 46, 54);
